...
module "oci_lz_compartments" {
  ...
  source                     = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//compartments?ref=v0.3.0"
...
module "oci_lz_groups" {
  ...
  source               = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//groups?ref=v0.3.0"
  providers            = { oci = oci.home }
  tenancy_ocid         = var.tenancy_ocid
...
module "oci_lz_dynamic_groups" {
  ...
  source                       = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//dynamic-groups?ref=v0.3.0"
  providers                    = { oci = oci.home }
  tenancy_ocid                 = var.tenancy_ocid
...
module "oci_lz_policies" {
  ...
  source                  = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//policies?ref=v0.3.0"
  providers               = { oci = oci.home }
  tenancy_ocid            = var.tenancy_ocid
...
module "oci_lz_identity_domains" {
  ...
  source                                           = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//identity-domains?ref=v0.3.0"
  providers                                        = { oci = oci.home }
  tenancy_ocid                                     = var.tenancy_ocid

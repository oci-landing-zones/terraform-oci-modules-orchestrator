...
module "oci_lz_compartments" {
  ...
  source                     = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//compartments?ref=release-0.2.5"
...
module "oci_lz_groups" {
  ...
  source               = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//groups?ref=release-0.2.5"
  providers            = { oci = oci.home }
  tenancy_ocid         = var.tenancy_ocid
...
module "oci_lz_dynamic_groups" {
  ...
  source                       = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//dynamic-groups?ref=release-0.2.5"
  providers                    = { oci = oci.home }
  tenancy_ocid                 = var.tenancy_ocid
...
module "oci_lz_policies" {
  ...
  source                 = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//policies?ref=release-0.2.5"
  providers              = { oci = oci.home }
  tenancy_ocid           = var.tenancy_ocid
...
module "oci_lz_identity_domains" {
  ...
  source                 = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//identity-domains?ref=release-0.2.5"
  providers              = { oci = oci.home }
  tenancy_ocid           = var.tenancy_ocid

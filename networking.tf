...
module "oci_lz_network" {
  ...
  source                  = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-networking.git?ref=v0.6.6"
...
module "oci_lz_nlb" {
  ...
  source                  = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-networking.git//modules/nlb?ref=v0.6.6"

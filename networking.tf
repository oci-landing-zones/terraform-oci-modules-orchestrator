...
module "oci_lz_network" {
  ...
  source                  = "git::https://github.com/oci-landing-zones/terraform-oci-modules-networking.git?ref=v0.7.1"
...
module "oci_lz_nlb" {
  ...
  source                  = "git::https://github.com/oci-landing-zones/terraform-oci-modules-networking.git//modules/nlb?ref=v0.7.1"

...
module "oci_lz_network" {
  ...
  source                  = "git::https://github.com/oci-landing-zones/terraform-oci-modules-networking.git?ref=v0.6.6"
...
module "oci_lz_nlb" {
  ...
  source                  = "git::https://github.com/oci-landing-zones/terraform-oci-modules-networking.git//modules/nlb?ref=nlb-public-ips"

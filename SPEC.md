...
| <a name="module_oci_lz_autonomous_databases"></a> [oci\_lz\_autonomous\_databases](#module\_oci\_lz\_autonomous\_databases) | git::https://github.com/oci-landing-zones/terraform-oci-modules-exadata.git//autonomous-database | release-1.2.0 |
| <a name="module_oci_lz_autonomous_recovery_service"></a> [oci\_lz\_autonomous\_recovery\_service](#module\_oci\_lz\_autonomous\_recovery\_service) | git::https://github.com/oci-landing-zones/terraform-oci-modules-exadata.git//autonomous-recovery-service | release-1.2.0 |
...
| <a name="module_oci_lz_cloud_exadata_database"></a> [oci\_lz\_cloud\_exadata\_database](#module\_oci\_lz\_cloud\_exadata\_database) | git::https://github.com/oci-landing-zones/terraform-oci-modules-exadata.git//exadata-database | release-1.2.0 |
...
| <a name="module_oci_lz_compartments"></a> [oci\_lz\_compartments](#module\_oci\_lz\_compartments) | git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//compartments | v0.3.5 |
| <a name="module_oci_lz_compute"></a> [oci\_lz\_compute](#module\_oci\_lz\_compute) | git::https://github.com/oci-landing-zones/terraform-oci-modules-workloads.git//cis-compute-storage | v0.2.8 |
| <a name="module_oci_lz_dynamic_groups"></a> [oci\_lz\_dynamic\_groups](#module\_oci\_lz\_dynamic\_groups) | git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//dynamic-groups | v0.3.5 |
...
| <a name="module_oci_lz_groups"></a> [oci\_lz\_groups](#module\_oci\_lz\_groups) | git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//groups | v0.3.5 |
...
| <a name="module_oci_lz_identity_domains"></a> [oci\_lz\_identity\_domains](#module\_oci\_lz\_identity\_domains) | git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//identity-domains | v0.3.5 |
| <a name="module_oci_lz_logging"></a> [oci\_lz\_logging](#module\_oci\_lz\_logging) | git::https://github.com/oci-landing-zones/terraform-oci-modules-observability.git//logging | v0.2.6 |
| <a name="module_oci_lz_network"></a> [oci\_lz\_network](#module\_oci\_lz\_network) | git::https://github.com/oci-landing-zones/terraform-oci-modules-networking.git | v0.8.3 |
| <a name="module_oci_lz_nlb"></a> [oci\_lz\_nlb](#module\_oci\_lz\_nlb) | git::https://github.com/oci-landing-zones/terraform-oci-modules-networking.git//modules/nlb | v0.8.3 |
| <a name="module_oci_lz_notifications"></a> [oci\_lz\_notifications](#module\_oci\_lz\_notifications) | git::https://github.com/oci-landing-zones/terraform-oci-modules-observability.git//notifications | v0.2.6 |
...
| <a name="module_oci_lz_oke"></a> [oci\_lz\_oke](#module\_oci\_lz\_oke) | git::https://github.com/oci-landing-zones/terraform-oci-modules-workloads.git//cis-oke | v0.2.8 |
| <a name="module_oci_lz_policies"></a> [oci\_lz\_policies](#module\_oci\_lz\_policies) | git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-iam.git//policies | v0.3.5 |
...
| <a name="module_oci_lz_service_connectors"></a> [oci\_lz\_service\_connectors](#module\_oci\_lz\_service\_connectors) | git::https://github.com/oci-landing-zones/terraform-oci-modules-observability.git//service-connectors | v0.2.6 |
| <a name="module_oci_lz_streams"></a> [oci\_lz\_streams](#module\_oci\_lz\_streams) | git::https://github.com/oci-landing-zones/terraform-oci-modules-observability.git//streams | v0.2.6 |
...
| [time_sleep.iam_policy_group_propagation](https://registry.terraform.io/providers/hashicorp/time/latest/docs/resources/sleep) | resource |
...
| <a name="input_exadata_database_dependency"></a> [exadata\_database\_dependency](#input\_exadata\_database\_dependency) | Module-native Exadata Database dependency object or path to cloud\_exadata\_database\_output.json. | `any` | `null` | no |
...
| <a name="input_recovery_service_dependency"></a> [recovery\_service\_dependency](#input\_recovery\_service\_dependency) | Module-native Autonomous Recovery Service dependency object, direct protection policy map, or path to autonomous\_recovery\_service\_output.json. | `any` | `null` | no |

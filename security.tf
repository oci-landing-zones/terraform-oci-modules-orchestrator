...
module "oci_lz_scanning" {
  ...
  source = "git::https://github.com/oci-landing-zones/terraform-oci-modules-security.git//vss?ref=release-0.1.7"
...
module "oci_lz_cloud_guard" {
  ...
  source = "git::https://github.com/oci-landing-zones/terraform-oci-modules-security.git//cloud-guard?ref=release-0.1.7"
...
module "oci_lz_security_zones" {
  ...
  source = "git::https://github.com/oci-landing-zones/terraform-oci-modules-security.git//security-zones?ref=release-0.1.7"
  tenancy_ocid                 = var.tenancy_ocid
...
module "oci_lz_vaults" {
  ...
  source = "git::https://github.com/oci-landing-zones/terraform-oci-modules-security.git//vaults?ref=release-0.1.7"
  providers = {
    oci = oci
    oci.home = oci.home
  }

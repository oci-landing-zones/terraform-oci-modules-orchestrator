...
module "oci_lz_scanning" {
  ...
  source = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-security.git//vss?ref=v0.1.5"
...
module "oci_lz_cloud_guard" {
  ...
  source = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-security.git//cloud-guard?ref=v0.1.5"
...
module "oci_lz_vaults" {
  ...
  source = "git::https://github.com/oracle-quickstart/terraform-oci-cis-landing-zone-security.git//vaults?ref=v0.1.5"
  providers = {
    oci = oci
    oci.home = oci.home
  }

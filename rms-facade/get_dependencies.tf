...
locals {
  ...
  clusters_dependency     = local.all_json_dependencies_map != null ? contains(keys(local.all_json_dependencies_map), "clusters") ? { "clusters" : local.all_json_dependencies_map.clusters } : null : null

...
module "oci_lz_budgets" {
  ...
  source                  = "git::https://github.com/oci-landing-zones/terraform-oci-modules-governance.git//budgets?ref=release-0.1.4"
...
module "oci_lz_tags" {
  ...
  source                  = "git::https://github.com/oci-landing-zones/terraform-oci-modules-governance.git//tags?ref=release-0.1.4"
  tenancy_ocid            = var.tenancy_ocid

...
module "oci_lz_streams" {
  ...
  source                  = "git::https://github.com/oci-landing-zones/terraform-oci-modules-observability.git//streams?ref=v0.2.5"
...
module "oci_lz_notifications" {
  ...
  source                      = "git::https://github.com/oci-landing-zones/terraform-oci-modules-observability.git//notifications?ref=v0.2.5"
...
module "oci_lz_events" {
  ...
  source                  = "git::https://github.com/oci-landing-zones/terraform-oci-modules-observability.git//events?ref=v0.2.5"
...
module "oci_lz_alarms" {
  ...
  source                  = "git::https://github.com/oci-landing-zones/terraform-oci-modules-observability.git//alarms?ref=v0.2.5"
  tenancy_ocid            = var.tenancy_ocid
...
module "oci_lz_logging" {
  ...
  source                  = "git::https://github.com/oci-landing-zones/terraform-oci-modules-observability.git//logging?ref=v0.2.5"
  tenancy_ocid            = var.tenancy_ocid
...
module "oci_lz_service_connectors" {
  ...
  source = "git::https://github.com/oci-landing-zones/terraform-oci-modules-observability.git//service-connectors?ref=v0.2.5"
  providers = {
    oci                  = oci
    oci.home             = oci.home
